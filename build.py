...
if sys.argv[1] == 'test-transit':
    os.system("java -classpath jlewi/lib/commons-lang3-3.13.0.jar:astromaestro.jar swisseph.Transits  -b1/1/2025 -B30/1/2030 -p0123456789 -P0123456789 -lon60")
